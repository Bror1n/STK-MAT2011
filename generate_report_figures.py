...
axes[0].plot(EPS_GRID, mean_se_a,'s--', color='tab:blue',   ms=3.5, alpha=0.55, label=r'Hessian se of $\widehat{a}$')
axes[0].plot(EPS_GRID, mc_sd_b,  'o-',  color='tab:orange', ms=3.5, label=r'MC sd of $\widehat{b}$')
axes[0].plot(EPS_GRID, mean_se_b,'s--', color='tab:orange', ms=3.5, alpha=0.55, label=r'Hessian se of $\widehat{b}$')
...
axes[1].plot(EPS_GRID, mc_sd_a / base_a, 'o-', color='tab:blue',   ms=3.5, label=r'$\widehat{a}$')
axes[1].plot(EPS_GRID, mc_sd_b / base_b, 'o-', color='tab:orange', ms=3.5, label=r'$\widehat{b}$')
